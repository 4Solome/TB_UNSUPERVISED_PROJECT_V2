...
st.caption(
    "This prototype supports latent TB phenotype discovery, pseudotime-based risk sequencing, "
    "OOD screening, and qualitative synthetic profile generation. It is intended for research "
    "and analytical use, not direct clinical diagnosis."
)
